...
@ControllerAdvice
public class ResourceExeceptionHandler extends ResponseEntityExceptionHandler{

	@ExceptionHandler(NotFoundException.class)
	public ResponseEntity<ApiError> handleNotFoundExeception(NotFoundException ex) {
